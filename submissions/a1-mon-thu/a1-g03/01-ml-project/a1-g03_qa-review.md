# QA Review a1-g03 <group-id> 01-ml-project <project-folder-name>
...
**Notes:** all the methodology match what the brief asked for but the results doesn't make senses so, they need to reconsider there decision. (don't pass this stage)

## 4. Clarity

Is the notebook/report readable — labeled sections, explained reasoning, not just code with no narrative?

**Notes:** Yes, they labeled each sections clearly and explain every step is clearly too but for decision they take some of them need to reconsider. (don't pass this stage)
...
_
first: file name is wrong your name is a1-g03_01-ml-project . ipynb but it should be a1-g03_01-ml-project.
second: you need to review your K from the graphic again this point is important.
third: in the persona you need to connect your names with the table not just high or lower.
_
